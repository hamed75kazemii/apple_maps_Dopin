...
| `backgroundColor` | `0x33FFFFFF` | گلس سفید ~۸۰٪ شفاف + شین ۱۵٪ در −۴۵° |
...
لمس مارکر: برای `Annotation` با `onTap`، کلیک روی مارکر (و خود دیالوگ) همان `onTap` را صدا می‌زند — ساب‌ویوهای دیالوگ `userInteraction` ندارند و تپ را بلاک نمی‌کنند. برای موقعیت من از `AppleMap.onMyLocationTap` استفاده کنید.
